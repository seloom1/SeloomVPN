...
**v1.1.1** — إصلاح إعادة تطبيق قائمة التطبيقات المستثناة عند تغييرها أثناء اتصال VPN، مع إضافة قائمة التطبيقات القابلة للبحث، أيقونات التطبيقات، التحكم بتطبيقات النظام، ودعم تطبيقات الباقة المجانية.
